...
##### 621.06
When we try to fill all space with *regular* tetrahedra, we are frustrated because the tetrahedra will not fill in the voids above the triangular-based grid pattern. But the regular tetrahedron is a complementary space filler with the octahedron. [[950.00 Allspace Filling#951|Sec. 951]] describes irregular tetrahedral allspace fillers.
##### 621.07
