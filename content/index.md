...
.link-tray .link-btn {
  width: 100%;
  justify-content: center;
  margin: 0; /* remove individual vertical margins */
}
...
This project carries that lineage forward — rebuilt with today's web-tech. It brings the complete text over page by page from the [original digitization](https://rwgrayprojects.com/synergetics/synergetics.html), with supplementary editorial help from [Buckyverse.org](https://buckyverse.org).
...
- Fiddle — explore interactive versions of Bucky's original diagrams [[Interactive figures|here]] 
...
<div class="link-tray">
  ...
  <button class="link-btn" type="button" onclick="window.dispatchEvent(new CustomEvent('open-feedback'))">
