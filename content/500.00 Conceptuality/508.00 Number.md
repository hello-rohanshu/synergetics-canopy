...
##### 508.20
(N² - N) / 2 is always a triangular number as, for instance, the number of balls in the rack on a pool table. A telephone connection is a circuit; a circuit is a circle; two people need one circuit and three people need three circles, which make a triangle. Four people need six circuits, and six circuits cluster most economically and symmetrically in a triangle. Five people need 10 private circuits, six people need 15, and seven people need 21, and so on: all are triangular numbers. (See [[220.00 Synergetics Principles#227.00 Principle of Order Underlying Randomness|Sec. 227, Order Underlying Randomness]], and [[220.00 Synergetics Principles#227.01|illustration 227.01]].)
##### 508.30
...
(where R = the number of rows (or the number of balls in the longest row). (See [[220.00 Synergetics Principles#230.00 Tetrahedral Number|Sec. 230, Tetrahedral Number]].)