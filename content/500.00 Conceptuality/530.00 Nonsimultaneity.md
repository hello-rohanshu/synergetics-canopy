...
##### 530.11
Any point can tune in any other point in Universe ([[960.00 Powers and Dimensions#960.08|Sec. 960.08]]). Between any two points in Universe there is a tetrahedral connection (see [[960.00 Powers and Dimensions#961.30|Sec. 961.30]]). Thus systematic connection of two points results in the interconnecting of four points. But none of the four event points of the tetrahedron are simultaneous. They are all overlappingly co- occurrent, each with different beginnings and endings. All of the atoms are independently introduced and terminaled; many are in gear—that is, synchronously tuned—but many are also way out of gear, untuned, or "noisy."
##### 530.12
Nouns can co-occur at the same time, but verbs cannot. Events can never be omnicongruently simultaneous, which would mean having all the component four events' beginnings and endings always simultaneous. Events occur. Occur is a time word. The overlappingness of Scenario Universe (see [[320.00 Scenario Universe|Sec. 320]]) makes events appear simultaneous when they are not. Events are only overlappingly co-occurrent but never omnisimultaneous.
##### 530.13
